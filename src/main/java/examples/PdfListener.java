 ...
 * PdfListener
 *
 * @see <a href="https://github.com/whitejeffreyl/JeffWhite/blob/master/testng/pdfListener.java">Jeff White's PdfListener class</a>
 */
public class PdfListener implements ITestListener {
     ...
     * reporter
     */
    private EmailablePdfReporter reporter;
    ...
    /**
     * @see <a href="http://testng.org/javadoc/org/testng/ITestListener.html">com.beust.testng.ITestListener.onTestSuccess(com.beust.testng.ITestResult)</a>
     */
    public void onTestSuccess(ITestResult result) {
        ...
        Paragraph p = new Paragraph("PASSED TESTS  -" + result.getMethod().getDescription(), new Font(Font.TIMES_ROMAN, 8, Font.BOLD));
    ...
    /**
     * @see <a href="http://testng.org/javadoc/org/testng/ITestListener.html">com.beust.testng.ITestListener.onTestFailure(com.beust.testng.ITestResult)</a>
     */
    public void onTestFailure(ITestResult result) {
        ...
        Paragraph p = new Paragraph("FAILED TEST -" + result.getMethod().getDescription(), new Font(Font.TIMES_ROMAN, 8, Font.BOLD));
        p.setAlignment(Element.ALIGN_CENTER);
        PdfPCell cell = new PdfPCell(p);
        cell.setColspan(4);
        ...
        this.failTable.addCell(cell);
        p = new Paragraph("Exception", new Font(Font.TIMES_ROMAN, 8, Font.BOLD));
        p.setAlignment(Element.ALIGN_CENTER);
        cell = new PdfPCell(p);
        cell.setColspan(4);
        cell.setBackgroundColor(Color.LIGHT_GRAY);
        ...
        p = new Paragraph("TEST STEPS", new Font(Font.TIMES_ROMAN, 8, Font.BOLD));
        p.setAlignment(Element.ALIGN_CENTER);
        cell = new PdfPCell(p);
        cell.setColspan(4);
        cell.setBackgroundColor(Color.LIGHT_GRAY);
    ...
    /**
     * @see <a href="http://testng.org/javadoc/org/testng/ITestListener.html">com.beust.testng.ITestListener.onTestSkipped(com.beust.testng.ITestResult)</a>
     */
    public void onTestSkipped(ITestResult result) {
        ...
        Paragraph p = new Paragraph("SKIPPED TESTS  -" + result.getMethod().getDescription(), new Font(Font.TIMES_ROMAN, 8, Font.BOLD));
        p.setAlignment(Element.ALIGN_CENTER);
        PdfPCell cell = new PdfPCell(p);
        cell.setColspan(4);
    ...
    /**
     * @see <a href="http://testng.org/javadoc/org/testng/ITestContext.html">com.beust.testng.ITestListener.onStart(com.beust.testng.ITestContext)</a>
     */
    public void onStart(ITestContext context) {
        log("onStart(" + context + ")");
        file = new File(PropertiesUtil.readPropertiesFile("src/main/resources/properties/testData.properties", "test.reportName"));
        ...
        Paragraph p = new Paragraph(context.getName() + " TESTNG RESULTS",
                FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new Color(28, 33, 34)));
    ...
    /**
     * @see <a href="http://testng.org/javadoc/org/testng/ITestContext.html">com.beust.testng.ITestListener.onFinish(com.beust.testng.ITestContext)</a>
     */
    public void onFinish(ITestContext context) {
        ...
        Paragraph p = new Paragraph("STATISTICS", new Font(Font.TIMES_ROMAN, 8, Font.BOLD));
        p.setAlignment(Element.ALIGN_CENTER);
        PdfPCell cell = new PdfPCell(p);
        cell.setColspan(5);
        cell.setBackgroundColor(Color.LIGHT_GRAY);
        ...
        cell.setBackgroundColor(Color.LIGHT_GRAY);
        this.statTable.addCell(cell);
        cell = new PdfPCell(new Paragraph("Total Time (ms)"));
        cell.setBackgroundColor(Color.LIGHT_GRAY);
        this.statTable.addCell(cell);
        ...
        p = new Paragraph("Data Chart", new Font(Font.TIMES_ROMAN, 8, Font.BOLD));
        p.setAlignment(Element.ALIGN_CENTER);
        cell = new PdfPCell(p);
        cell.setColspan(4);
        cell.setBackgroundColor(Color.LIGHT_GRAY);
       ...
       reporter = new EmailablePdfReporter();
        try {
            reporter.emailResults(PropertiesUtil.readPropertiesFile("src/main/resources/properties/testData.properties", "test.reportName"));
